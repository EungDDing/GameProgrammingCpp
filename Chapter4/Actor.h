...
public:
	...
	void ProcessInput(const uint8_t* keyState); // ProcessInput function called from Game (not overridable)
	virtual void ActorInput(const uint8_t* keyState); // any actor-specific input code(overridable)
